...
import os
import json
from error_handler import LeadFormErrorHandler
from rabbitmq import RabbitMQConsumer
from customers import add_new_customer
...
consumer = RabbitMQConsumer(
    queue_name=creds.Consumer.design_lead_form, callback_func=process_design_lead, eh=LeadFormErrorHandler
)
